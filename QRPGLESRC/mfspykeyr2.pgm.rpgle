     ...
     h copyright('Open Text Corporation')
      ...
      //
J6082 // 02-05-15 PLR Increase size of licensed users from 3 to 6 digits. Doing
      //              this causes the current method of tracking licenses to
      //              exceed the capacity of a user space. Converting to use a
      //              user index.
...
J2163d setFldVal       pr
     ...
     D  CUS_SPCNAM                   20
     D  CUS_EXTATR                   10    CONST
     D  CUS_ISIZE                    10I 0 CONST
     D  CUS_IVAL                      1    CONST
     D  CUS_AUTH                     10    CONST
     D  CUS_DESC                     50    CONST
     D  CUS_RPLC                     10    CONST
...
J2163    loadWrkArr();
       ...
       BEGSR CRTULTSPC;
         ...
         // CREATE LICENSE TRACKING USER SPACE FOR EACH PRODUCT IN NEED.

      /END-FREE
     C                   MOVE      SKLPRD        ULTPRD#
      /FREE

J6082    if crtUI(%addr(ultSpc):16:16) <> 0;
J6082      reset uiError;
J6082      getLastUIError(%addr(uiError));
J6082      SPM('KY00062');
J6082      ERRORS = '1';
J6082    endif;
