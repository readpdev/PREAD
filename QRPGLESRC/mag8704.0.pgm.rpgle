      ...
      *                                                                   *
J4124 * 04-13-12 PLR Prevent the reading of a subdirectory that is also   *
      *              the move-to directory. Was causing a nested creation *
      *              of directories until buffer space ran out and caused *
      *              an array index error. Fix prevents the reading of    *
      *              the configured move-to subdirectory. Generally, users*
      *              will configure their move-to directory in a          *
      *              location not under a monitored source directory.     *
...
4979 c                   EndIf
     ...
     c                   if        filtyp='D' and
J4124c                             ifsub = 'Y' and newifspth <> iempth
