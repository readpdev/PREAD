      ...
      *%EMETADATA                                                      *
     h dftactgrp(*no) actgrp(*new) bnddir('QC2LE':'DBGR')
           ...
           select;
             ...
             when option = '4';
               run('endjob ' + r_jobnum + '/*N/' +
                 %trimr(r_jobnam) + ' option(*immed) splfile(*yes) loglmt(0)');
             when option = '5';
      ...
      /FREE
       ...
       begsr strdbg;
         ...
         if not cancel and not exit and pgmnam <> ' ';
           ...
           if chkObjRtn <> 0; //Not found try for *SRVPGM.
